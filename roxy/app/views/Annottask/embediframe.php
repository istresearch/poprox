...
$jsCode = <<<EOD
var qUrl = "{$this->getSiteURL("/annottask")}/";
...
You can help right now by joining our micro tasking team to help us uncover hidden text. <br>
<br>
All you have to do is scroll down and click “Opt In” below to get started. We will show you original text, and your job is to determine the true english meaning behind it. 
Thank you for supporting the fight against human trafficking!<br>
<br>
The goal of this annotation is to produce normal English text from obfuscated, irregular, and/or highly stylized English used in escort ads and other similar venues.  Because we will be training a statistical natural language model, it is important to generate output which maps directly into the rewritings the model is able to produce.  Accordingly, please:
<OL><LI> Feel free to delete bytes/character subsequences from the input but not to reorder them
<LI> Map the inputs into word sequences that use widely accepted capitalization/writing standards
<LI> Apply any word-rewritings that lead to better outputs, including but not limited to spelling corrections, contractions, expansions, etc.
<LI> The only insertions that are accepted are blank characters and end of “sentence” markers.
</OL>
<br>
EOD;
$w .= '</p></div><br />'."\n";
